...
if os.path.exists(project_root_env):
    ...
    # If no .env in root, try loading environment variables (for production environments)
...
class Config:
    ...
    # JSON config - disable ASCII escaping so non-ASCII characters display directly (instead of \uXXXX)
    JSON_AS_ASCII = False
